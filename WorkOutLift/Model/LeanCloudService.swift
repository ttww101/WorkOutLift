...
class LeanCloudService {
    ...
    func configure() {
        do {
            try LCApplication.default.set(
                id:  "hD2UmM3EqpolSuJ9tfIjKpa9-gzGzoHsz",
                key: "XlTH71Pu5nQAeRBje11YXth4"
            )
        } catch {
            print("")
        }
    ...
    func getPrivacy(completion: @escaping (BeginModel?, Error?) -> Void) {
        ...
        let _ = query.getFirst { (result) in
            ...
            case .success(object: let object):
                ...
                let beginModel = BeginModel(title: title, privacy: privacy)
